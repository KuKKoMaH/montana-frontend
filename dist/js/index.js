...
var _initGallery = __webpack_require__(6);

var _initGallery2 = _interopRequireDefault(_initGallery);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

$('.' + "src-modules-slider-wrapper").each(function () {
  var $this = $(this);
  (0, _initGallery2.default)({
    $items: $this.find('.' + "src-modules-slider-slide")
  });

  $this.find('.' + "src-modules-slider-block").slick({
...
module.exports = function initGalley(config) {
  ...
  function openGallery(i) {
    ...
    $container.on('mousedown.gallery', function (mousedownEvent) {
      isDown = true;
